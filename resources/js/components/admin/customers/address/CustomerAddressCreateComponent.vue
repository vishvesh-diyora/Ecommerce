                    ...
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.full_name" v-bind:class="errors.full_name ? 'invalid' : ''"
                                   type="text"
                                   id="full_name" class="db-field-control"/>
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <div :class="errors.phone ? 'invalid' : ''" class="db-field-control flex items-center">
                                ...
                                <input v-model="props.form.phone" v-on:keypress="phoneNumber($event)" v-bind:class="errors.phone ? 'invalid' : ''" type="text" id="phone" class=" pl-2 text-sm w-full h-full"/>
                            </div>
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label class="db-field-title required" for="street_address">{{
                                ...
                                }}</label><input type="text" :class="errors.address ? 'invalid' : ''"
                                                 v-model="props.form.address" class="db-field-control">
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                this.loading.isActive = true;
                this.$store.dispatch("customerAddress/save", {
