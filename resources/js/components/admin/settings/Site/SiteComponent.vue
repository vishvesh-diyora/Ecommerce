            ...
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-on:keypress="floatNumber($event)" v-model="form.site_non_purchase_product_maximum_quantity"
                            v-bind:class="errors.site_non_purchase_product_maximum_quantity ? 'invalid' : ''" type="text"
                            id="site_non_purchase_product_maximum_quantity" class="db-field-control" />
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="cash_on_delivery_enable">{{ $t("label.cash_on_delivery")
                        }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input type="radio" v-model="form.site_is_return_product_price_add_to_credit" id="yes"
