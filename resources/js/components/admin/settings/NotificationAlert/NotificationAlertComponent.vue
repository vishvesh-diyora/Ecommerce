<template>
    ...
    <div id="notify" class="db-tab-div font-medium active">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-5">
            <button @click="selectActive(index)"
                ...
                <i class="lab lab-line-mail text-sm" v-if="notificationAlert.slug === 'mail'"></i>
                <i class="lab lab-line-sms text-sm" v-if="notificationAlert.slug === 'sms'"></i>
                <i class="lab lab-line-notification text-sm" v-if="notificationAlert.slug === 'push_notification'"></i>
