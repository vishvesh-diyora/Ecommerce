    ...
    <div id="modal" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">{{ $t("menu.benefits") }}</h3>
                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.title" type="text" id="title" class="db-field-control" />
                        ...
                        <div class="form-col-12 sm:form-col-12">
                            <label for="image" class="db-field-title required">{{ $t('label.image') }} (24px,24px)</label>
...
export default {
    ...
    data() {
        return {
            ...
            addButton: {
                title: this.$t("button.add_benefit"),
            },
            enums: {
    ...
    methods: {
        ...
        reset: function () {
            ...
            this.$store.dispatch("benefit/reset").then().catch();
            this.errors = {};
        ...
        save: function () {
            try {
                ...
                const tempId = this.$store.getters["benefit/temp"].temp_id;
                this.loading.isActive = true;
                this.$store.dispatch('benefit/save', {
                    form: fd,
