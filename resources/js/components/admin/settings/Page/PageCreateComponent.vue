                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <vue-select class="db-field-control f-b-custom-select" id="menu_section_id" v-bind:class="errors.menu_section_id ? 'invalid' : ''
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <vue-select class="db-field-control f-b-custom-select" id="template_id" v-bind:class="errors.menu_template_id ? 'invalid' : ''
                                " v-model="props.form.menu_template_id" :options="menuTemplates" label-by="name"
                                value-by="id" :closeOnSelect="true" :searchable="true" :clearOnClose="true" placeholder="--"
                                search-placeholder="--" />
                            <small class="db-field-alert" v-if="errors.menu_template_id">{{ errors.menu_template_id[0]
                            }}</small>
                        </div>
                        ...
                        <div class="form-col-12">
                            ...
                            <quill-editor v-model:value="props.form.description"
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                fd.append(
                    "menu_template_id",
                    this.props.form.menu_template_id === null
                        ? 0
                        : this.props.form.menu_template_id
                );
                if (this.image) {
